...
export default function FloatingButton() {
  ...
  return (
    <>
      ...
      {(isOpen || isClosing) && (
        <div className={`fixed bottom-24 right-6 z-40 w-96 h-[600px] bg-white rounded-lg shadow-2xl flex flex-col ${
          isClosing ? "animate-slide-down" : "animate-slide-up"
        }`}>
          {/* Header */}
          <div className="p-4 bg-white border-b border-gray-200 flex items-center justify-between rounded-t-lg">
            <h3 className="font-semibold text-gray-800">PW3 AI 출석 조교</h3>
            <button 
              onClick={handleToggle}
